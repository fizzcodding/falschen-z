...
const footerArt = "/assets/falschen-footer-dither.svg";
        ...
        <div className="footer-main">
          <div className="footer-brand-block">
            <div className="footer-brand">
              <img src={logoUrl} alt="Team Fälschen anvil and hammer mark" />
              <div>
                <strong>FÄLSCHEN</strong>
                <span>Forged. Wired. Perfected.</span>
              </div>
            </div>
