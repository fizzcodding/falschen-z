 ...
 * The raster readout renders ascii.png as a plain image (no ASCII art effect).
 */
  ...
  return (
    <section className="lifesphere-section section-pad" id="lifesphere" aria-labelledby="lifesphere-title">
      ...
      <div className="container">
        <SectionHeading index="SEC 01" kicker="THE SPOTLIGHT OF THIS YEAR" title="LIFESPHERE" id="lifesphere-title" highlight />

        {/* 1. Introduction grid: description + raster readout */}
        <div className="ls-intro">
          ...
          <aside className="ls-raster panel-flat">
            <div className="ls-raster-head mono"><span>LIFESPHERE MARK / READOUT</span></div>
            ...
            <div className="ls-raster-foot mono"><span>RES / ASCII</span><span className="accent-text">● SIGNAL</span></div>
          </aside>
        </div>
